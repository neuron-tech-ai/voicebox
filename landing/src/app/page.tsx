    ...
    <>
      ...
      <section className="relative pt-32 pb-16">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center">
          ...
          >
            Clone voices, generate speech across seven TTS engines, dictate into any app, and talk
            to agents in voices you own. A free and local alternative to ElevenLabs and WisprFlow,
            running <b className="text-white">entirely on your machine.</b>
          </p>
